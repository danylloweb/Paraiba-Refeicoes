        ...
        <div class="center">
            ...
            <nav id="menu">
                <ul class="btn-1">
                    ...
                    <li class="activ"><a href="servico.php">Serviços</a></li>
    ...
    <section id="wrap-centro">
        <div class="center">
            <div id="content-conteudo">
              <h1 class="titulos-1">Conheça nossos <span>Serviços</span></h1>
              <div id="box-institucional" class="interna-box">
              <div class="img-inst"><img src="media/images/img-slid.jpg" alt=""></div>
              <h1 class="t-serv">REFEIÇÕES PARA EVENTOS: </h1>
                <p>
                O restaurante Paraíba Grill,fornecem refeições coletivas para eventos, envolvendo confraternizações e encontros empresariais de âmbito previamente definidos, quando são elaborados cardápios personalizados, de acordo com o perfil dos convidados e o tema do evento, para uma equipe de profissionais possa fazer o atendimento. As refeições podem ser preparadas na cozinha do Paraíba Grill, devendo ser transportadas até o loca, ou preparada na própria empresa.   
                 </p>   
              <h1 class="t-serv">REFEIÇÕES PARA EVENTOS: </h1>
                <p>
                O restaurante Paraíba Grill,fornecem refeições coletivas para eventos, envolvendo confraternizações e encontros empresariais de âmbito previamente definidos, quando são elaborados cardápios personalizados, de acordo com o perfil dos convidados e o tema do evento, para uma equipe de profissionais possa fazer o atendimento. As refeições podem ser preparadas na cozinha do Paraíba Grill, devendo ser transportadas até o loca, ou preparada na própria empresa.   
            ...
            <div id="sid-right">
                <div class="t-2"><h1 class="titulos-2 titulos-1">Peça <span>Online</span></h1></div>
                <div class="box-2">
                    <h2>É prático e Rápido</h2>
                    <div id="img-pedir" class="sprit"></div>
                    <a href=""  id="bt-pedir" class="btn-1"><span class="sprit ic-car"></span> Pedir</a>
                </div><!--/box-link-pedir-->
