       ...
       <div id="box-pedidos">
           ...
           <nav class="nav-etapas">
            ...
            <table class="tab-carrinho">
                <thead>
                       <tr>
                             <th class="t-carrinho">Marmita 
                             <th class="t-carrinho">Excluir
                             <th class="t-carrinho">Subtotal


                <!-- Corpo da tabela -->    
                    <tbody>
                        <tr>
                            <th class="info-marmita">Feijão carioca - Arroz branco - Macarrão espaguete com carne moída - Salada tropical Salada crua - Bife grelhado com alho - Filé de frango à milanesa
                            <td><a href="" class="sprit exclui-m"></a>
                            <td class="valor-marmita">R$ 9,99
                        <tr>
                            <th class="info-marmita">Feijão carioca - Arroz branco - Macarrão espaguete com carne moída - Salada tropical Salada crua - Bife grelhado com alho - Filé de frango à milanesa
                            <td><a href="" class="sprit exclui-m"></a>
                            <td class="valor-marmita">R$ 9,99
                      ...
                      <tfoot> 
                       <tr> 
                             <th>
                             <th>
                             <th class="total-carrinho">Total: 19,98
                </table>

          
                
           <a href="index.php" class="btn-1">Adicionar Marmita</a>
           <a href="identificacao.php" class="btn-1 right">Próxima etapa</a>
       </div><!-- box-pedidos -->
   </div>
