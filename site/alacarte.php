    ...
    <section id="wrap-centro">
        <div class="center">
            <div id="content-conteudo">
              ...
              <div class="img-inst carda-img"><img src="media/images/img-slid.jpg" alt=""></div>   
               <h1 class="t-dia">Carnes:</h1> 
               <div class="type-item">Estrogonofe de Filé <span class="desc-item">Arroz a grega e purê.</span></div>
               <div class="type-item">Estrogonofe de Filé <span class="desc-item">Arroz a grega e purê.</span></div>
               <div class="type-item">Estrogonofe de Filé <span class="desc-item">Arroz a grega e purê.</span></div>
               <div class="type-item">Estrogonofe de Filé <span class="desc-item">Arroz a grega e purê.</span></div>
               <div class="type-item">Estrogonofe de Filé <span class="desc-item">Arroz a grega e purê.</span></div>
            ...
            <div id="sid-right">
                <nav id="nav-interna">
                    <ul>
                        <li><a href="cardapio.php">Cardápio</a></li>
                        <li class="activ"><a href="calacarte.php">À la Carte</a></li>
                    </ul>
                </nav>
