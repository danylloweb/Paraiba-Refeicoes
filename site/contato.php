        ...
        <div class="center">
            ...
            <nav id="menu">
                <ul class="btn-1">
                    ...
                    <li class="activ"><a href="contato.php">Contato</a></li>
                </ul>
            </nav>
        </div><!--/center-->
    </header><!--/topo-->
        ...
        <div class="center">
            ...
            <p class="txt-contato">Entre em contato conosco para encaminhar alguma duvida, crítica, elogio ou sugestão, preencha o formulário abaixo e retornaremos o mais breve possível.</p>
              <form action="" id="form-contato">
                  <input type="text" class="type-form" placeholder="Nome">
                  <input type="text" class="type-form" placeholder="E-mail">
                  <input type="text" class="type-form" placeholder="Telefone">
                  <textarea name="" class="type-form" id="area-form" placeholder="Mensagem"></textarea>
