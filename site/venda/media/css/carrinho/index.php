<div class="center">
    ...
    <div id="box-pedidos">
        <div class="txt1 n-quentinha"><b>Quentinha R$ <?= number_format($preco_quentinha, 2, ',', '.') ?></b>  -Entregamos apenas no Bessa as marmitas individuais e as empresas nas demais localidades da grande João Pessoa e Cabedelo.<br><b>Horário de entrega de 11h as 14h
