...
<body>
   ...
   <div class="center">
    ...
    <form action="http://paraibarefeicoes.com.br/carrinho/atualizar_carrinho" method="post" accept-charset="utf-8">        <table class="tab-carrinho">
            <thead>
                <tr>
...
<input type="hidden" name="1_rowid" value="d645920e395fedad7bbbed0eca3fe2e0" />

                        <tr>
                            <th class="info-marmita">
                                Feijão carioca -                                 Arroz branco                                 - Macarrão espaguete com frango                                 - Acelga com melão e abacaxi                                 - Acelga com melão e abacaxi                                 - Batata frita                                 - Frango à jardineira                                 - Filé de frango grelhado                                                            </th>                            
                            
                            <td><a href="http://paraibarefeicoes.com.br/carrinho/remover_marmita/d645920e395fedad7bbbed0eca3fe2e0" class="sprit exclui-m"></a></td>
                            <td class="valor-marmita">R$ 9,99</td>
                        </tr>
            ...
            <tfoot> 
                <tr> 
                    <th colspan="4" class="total-carrinho">Total: 9,99                    
                    </th>
        ...
        <a href="http://paraibarefeicoes.com.br/cardapio" class="btn-1">Adicionar Marmita</a>
        <a href="http://paraibarefeicoes.com.br/identificacao" class="btn-1 right">Próxima etapa</a>
    </div><!-- box-pedidos -->
</div>
