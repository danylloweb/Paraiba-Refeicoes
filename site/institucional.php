        ...
        <div class="center">
            ...
            <nav id="menu">
                <ul class="btn-1">
                    ...
                    <li class="activ"><a href="institucional.php">O Restaurante</a></li>
                     <li>
                        <a href="">Refeições</a>
                    ...
                    <li><a href="pedido.php">Faça seu Pedido</a></li>
    ...
    <section id="wrap-centro">
        <div class="center">
            <div id="content-conteudo">
              ...
              <div class="img-inst"><img src="media/images/img-slid.jpg" alt=""></div>   
...
+de 3,000 Refeições .. Atualmente, as nossas empresas fornecem mais de 3,000 refeições nas unidades de atendimento, envolvendo os mai diversos setores, onde os clientes têm à disposição um cardápio variado nos mais diversos tipos de serviços no ramo das refeições coletivas ou de eventos corporativos.  <br><br>
                  MÃO DE OBRA:
A equipe da nossa empresa é formada por profissionais especializados e experientes, que vivem em constante treinamento, oferecendo assim, refeições de altíssimo padrão de qualidade.

O PREPARO:
As refeições coletivas são preparadas, transportadas e entregues com o mais absoluto cuidado, a fim de evitar quaisquer problemas com os alimentos, já que são obedecidas as boas práticas definidas pelos órgãos fiscalizadores, envolvendo a higiene, conservação, armazenamento e preparo da alimentação.

SAÚDE: 
Os alimentos são balanceados e preparados com o aval de nutricionistas certificadso e experientes, o que faz com que os pratos, além do sabor, atendem a todas normas indicadas para um alimentação saudável.

TRANSPORTE:
Por contar com uma frota de veículos moderna e sempre pronta para efetuar qualquer deslocamento, O restaurante Paraíba Gill entrega todas as encomendas no dia acertado e no horário combinado.
            ...
            <div id="sid-right">
                <nav id="nav-interna">
                    <ul>
                        <li class="activ"><a href="institucional.php">Institucional</a></li>
                        <li><a href="ambiente.php">Ambiente</a></li>
                        <li><a href="clientes.php">Clientes Satisfeitos</a></li>
                    </ul>
                </nav>
                <div class="t-2"><h1 class="titulos-2 titulos-1"><span>Localização</span></h1></div>
                <div class="box-2">
                    <div id="box-map">
                        <iframe width="100%" height="175" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.br/maps?f=q&amp;source=s_q&amp;hl=pt-BR&amp;geocode=&amp;q=Av+Presidente+Nilo+Pe%C3%A7anha,&amp;aq=&amp;sll=-7.275677,-35.977657&amp;sspn=0.476099,0.837021&amp;ie=UTF8&amp;hq=&amp;hnear=Av.+Pres.+Nilo+Pe%C3%A7anha+-+Bessa,+Jo%C3%A3o+Pessoa+-+Para%C3%ADba,+58035-200&amp;t=m&amp;ll=-7.067163,-34.843655&amp;spn=0.007453,0.00854&amp;z=15&amp;output=embed"></iframe>
                    </div><!--/box-map-->
                    <div class="end-info">
                        Av Presidente Nilo Peçanha,<br>
                        Bessa, João Pessoa PB 58035200<br>

                        <b>Aberto todos os dias</b><br>
                        Horário: Das 11:00 as 16hrs
                    </div><!--/end-info-->
                </div><!--/box-2-->
                <div class="t-2"><h1 class="titulos-2 titulos-1"><span>Sociais</span></h1></div>
                <div class="box-2">
                    <div class="fb-like-box" data-href="http://www.facebook.com/FacebookDevelopers" data-width="215px" data-height="The pixel height of the plugin" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>
                </div>
            </div><!--/sid-right-->
        </div><!--/center-->
    </section><!--/wrap-centro-->
