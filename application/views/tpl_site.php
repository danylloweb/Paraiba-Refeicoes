...
<html lang="pt-br">
    ...
    <head>
        ...
        <link href="<?= base_url('public/includes/bootstrap-3.3.4-dist/css/bootstrap.css') ?>" rel="stylesheet">
        
        <script type="text/javascript" src="<?= base_url('public/includes/owl-carousel/owl.carousel.js') ?>"></script>
        
        <!-- *Owl Carrousel -->
        <link rel="stylesheet" type="text/css" href="<?= base_url('public/includes/owl-carousel/owl.carousel.css') ?>" />
        <link rel="stylesheet" type="text/css" href="<?= base_url('public/includes/owl-carousel/owl.theme.css') ?>" />
        <script type="text/javascript" src="<?= base_url('public/includes/owl-carousel/owl.carousel.js') ?>"></script>
    ...
    <body>
                ...
                <div class="row">
                            ...
                            <div class="form-rp">
                                ...
                                <?php echo form_open("", array('class' => 'formNewsletter')) ?>
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="ema_email" class="ipt-news form-control" placeholder="Digite seu e-mail" required="required">
                                        <div class="input-group-btn">
                                            <input type="submit" class="btn btn-default bt-assina" id="submitNewsletter" value="ok">
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div id="box-contato-rp">
                            ...
                            <div class="info-rp txt-rp"><!-- <span class="sprit ic-mail"></span> --> <a href="mailto:<?= $emailConf?>"><?= $emailConf?></a>  </div>                            
                        </div><!--/box-contato-rp-->
                    </div>
                    <div class="col-md-2">
                        <div class="info-rp2 txt-rp txt-tel ">
                            <!-- <span class="sprit ic-fone"></span> -->
                            <?= $foneConf?> <br> <?= $foneConfTwo?> 
                        </div>
                    </div>
        ...
        <script src="<?= base_url('public/animatedModal.min.js') ?>"></script>
